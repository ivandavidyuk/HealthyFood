...
// при перезагрузке страницы отображаются элементы у которых display: none. Сделать долгую анимацию появления?
// адаптив
// сначала должна открываться страница с калькулятором
// прижать футер книзу
